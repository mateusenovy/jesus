...
export default class CellFloatButton extends Component {
    ...
    handleOnClickNew() {
        ...
        this.handleClick(C.CELL_ACTION_BUTTON_NEW, true);
    }

    handleOnClickConfirm() {
        this.props.handleOnClickConfirm && this.props.handleOnClickConfirm();
        this.handleClick(C.CELL_ACTION_BUTTON_CONFIRM, false);
    }

    handleOnClickCancel() {
        this.props.handleOnClickCancel && this.props.handleOnClickCancel();
        this.handleClick(C.CELL_ACTION_BUTTON_CANCEL, false);
    }
