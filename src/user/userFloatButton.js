...
export default class UserFloatButton extends Component {
    ...
    handleOnClickNew() {
        ...
        this.handleClick(C.USER_ACTION_BUTTON_NEW);
    }

    handleOnClickConfirm() {
        this.props.handleOnClickConfirm && this.props.handleOnClickConfirm();
        this.handleClick(C.USER_ACTION_BUTTON_CONFIRM);
    }

    handleOnClickCancel() {
        this.props.handleOnClickCancel && this.props.handleOnClickCancel();
        this.handleClick(C.USER_ACTION_BUTTON_CANCEL);
    }
